...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String strToCheck = getStringFromFile("data/warAndPeace.txt", numToCheck);
			
			startTime = System.nanoTime();
			BasicDocument bd = new BasicDocument(strToCheck);
			tmpScore = bd.getFleschScore();
			endTime = System.nanoTime();
			System.out.print(endTime - startTime + "\t");
			
			startTime = System.nanoTime();
			EfficientDocument ed = new EfficientDocument(strToCheck);
			tmpScore = ed.getFleschScore();
			endTime = System.nanoTime();
